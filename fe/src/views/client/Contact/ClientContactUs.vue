                ...
                <div className="-mx-4 flex flex-wrap lg:justify-between">
                    <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div className="mb-12 max-w-[570px] lg:mb-0">
                            ...
                            <p className="mb-9 text-base leading-relaxed"> We are here to help. </p>
                            <div className="mb-8 flex w-full max-w-[370px]">
                                <div
                                    className="bg-theme-1st/10 text-theme-2nd mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-base"> Hanoi, Vietnam </p>
                                </div>
                            </div>
                            <div className="mb-8 flex w-full max-w-[370px]">
                                <div
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-base">(+84) 000000000</p>
                                </div>
                            </div>
                            <div className="mb-8 flex w-full max-w-[370px]">
                                <div
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-base">info@DApp.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                        <div className="relative rounded-lg bg-pink-50 p-8 shadow-box-shadow sm:p-12">
                            <form>
                                <div className="mb-6">
                                    <input type="text" name='name' placeholder="Your Name"
                                        className="border-[f0f0f0] focus:border-theme-2nd w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" />
                                </div>
                                <div className="mb-6">
                                ...
                                <div className="mb-6">
                                    <textarea rows="6" name='message' placeholder="Your Message"
                                        className="border-[f0f0f0] focus:border-theme-2nd w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"></textarea>
                                </div>
                                <div>
                                    <button type="submit"
                                        className="bg-primary border-theme-2nd w-full rounded border p-3 transition bg-gradient-to-r from-theme-2nd to-theme-1st">
                                        Send Message </button>
                                </div>
                            </form>
                        </div>
