<template>
  ...
  <div :class="containerClass" v-else>
    ...
    <a class="cursor-pointer" v-if="!(firstPageSelected() && hidePrevNext)" @click="prevPage()" @keyup.enter="prevPage()"
    ...
    <template v-for="page in pages">
      ...
      <a class="cursor-pointer" v-else-if="page.disabled"
        :class="[pageLinkClass, page.selected ? activeClass : '', disabledClass]" tabindex="0">{{ page.content }}</a>
      <a class="cursor-pointer" v-else @click="handlePageSelected(page.index + 1)"
